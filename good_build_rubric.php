...
/* First we increment the rating count for the student selected
...
$getratingcount = "SELECT RatingCount FROM studenttoberated WHERE StudentID = '".$studentid."'";
...
$updateratingcount = "UPDATE studenttoberated SET RatingCount = '".$ratingcount."' WHERE StudentID = '".$studentid."'";
