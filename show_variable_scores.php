...
$getpfid = "SELECT DISTINCT PortfolioRatingID FROM portfoliorating 
...
while ($pfids = mysqli_fetch_row($dogetpfid))
{
	...
	$getscore = "SELECT DISTINCT sessionscoring.score FROM rubriccontent LEFT JOIN sessionscoring
			ON sessionscoring.competencyid = '".$variable."' 
			WHERE sessionscoring.portfolioratingid = '".$pfid."'";
...
echo "<tr>";
echo "<td width=\"15%\" height=\"30\" align=\"right\">";
echo "Very Strongly Agree";
echo "</td>";

if ($pcsixes == 0)
{
	echo "<td width=\"1%\" style =\"background=color: #669966;\">";
}
else
{
	echo "<td width=\"".$pcsixes."%\" style=\"background-color: #669966;\">";
}
echo "</td>";
...
{
	echo "<td width=\"".$pcfives."%\" style=\"background-color: #669966;\">";
}
echo "</td>";
...
{
	echo "<td width=\"".$pcfours."%\" style=\"background-color: #669966;\">";
}
echo "</td>";
...
{
	echo "<td width=\"".$pcthrees."%\" style=\"background-color: #669966;\">";
}
echo "</td>";
...
{
	echo "<td width=\"".$pctwos."%\" style=\"background-color: #669966;\">";
}
echo "</td>";
...
{
	echo "<td width=\"".$pcones."%\" style=\"background-color: #669966;\">";
}
echo "</td>";
...
<table border="0" width="95%" cellpadding="10">
  ...
  <tr>
    ...
    <td width="30%" align="right" height="50">
	<input type="submit" value="View Different Report">
    </td>    
    <td width="55%" align="left" type="text/css"
     style="background-color: #669966; color: white; font-weight: bolder;">
    Select another type of report to view.
    </td>
    <td width="10%">
    </td>
    </form>
