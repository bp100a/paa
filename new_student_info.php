...
if ($num_students < 1)
{
	...
	echo "<tr>";
	echo "<td width=\"40%\" align=\"right\" height=\"150\">";
	echo "<h2>Select a new student to rate</h2>";
	echo "</td>";


	echo "<form method=\"POST\" action=\"build_rubric.php\">";
	echo "<td width=\"45%\" align=\"left\" height=\"150\">";
 ...
 */
	...
	echo "<tr>";
	echo "<td width=\"40%\" align=\"right\" height=\"100\">";
	echo "<h2>Modify the scores you have already given a student</h2>";
	echo "</td>";
	...
	if ($getnumrated < 1)
	{
		...
		echo "<td width=\"45%\" align=\"left\" height=\"100\">";
	...
	if ($adminstatus == 1)
	{
		...
		echo "<tr>";
		echo "<td width=\"40%\" align=\"right\" height=\"100\">";
		echo "<h2>Return to the Administrator page.</h2>";
		echo "</td>";
		echo "<td width=\"45%\" align=\"left\" height=\"100\">";
	...
	echo "<tr>";
	echo "<td width=\"40%\" align=\"right\" height=\"100\">";
	echo "<h2>Log out of the rating session.</h2>";
	echo "</td>";
	echo "<td width=\"45%\" align=\"left\" height=\"100\">";
